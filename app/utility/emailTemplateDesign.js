const forgetPasswordStyling = (token) => {
...
<body class="body"
    style="margin: 0; background-color: #d9dffa; padding: 0; -webkit-text-size-adjust: none; text-size-adjust: none;">
            ...
            <tr>
                <td>
                    <table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-1"
                        role="presentation"
                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #d9dffa; background-size: auto;"
                        width="100%">
                        <tbody>
                            <tr>
                                <td>
                                                            ...
                                                            <td class="pad">
                                                                <div
                                                                    ...
                                                                    <p style="margin: 0; word-break: break-word;">
                                                                        <strong><span
                                                                                style="word-break: break-word;">Forgot
                                                            ...
                                                            <td class="pad">
                                                                <div
                                                                    ...
                                                                    <p style="margin: 0; word-break: break-word;"><span
                                                                            style="word-break: break-word;">Hey, we
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <div
                                                                    style="color:#40507a;font-family:Helvetica Neue, Helvetica, Arial, sans-serif;font-size:16px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
                                                                    <p style="margin: 0; word-break: break-word;"><span
                                                                            style="word-break: break-word;">Let’s get
                                                                            you a new one!</span></p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
																		...
																		target="_blank"><span
																			style="word-break: break-word; padding-left: 25px; padding-right: 20px; font-size: 15px; display: inline-block; letter-spacing: normal;"><span
																				style="word-break: break-word;"><span
																					data-mce-style=""
																					style="word-break: break-word; line-height: 30px;"><strong>RESET
																						MY
																						PASSWORD</strong></span></span></span></a><!--[if mso]></center>
                                                                    </v:textbox>
                                                                    </v:roundrect><![endif]-->
																</div>
															</td>
														...
														<tr>
															<td class="pad">
																<div
																	...
																	<p style="margin: 0; word-break: break-word;"><span
																			style="word-break: break-word;">Having
																			trouble? <a href="http://www.example.com/"
																				rel="noopener"
...
module.exports = {forgetPasswordStyling}